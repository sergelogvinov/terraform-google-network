...
| <a name="input_capabilities"></a> [capabilities](#input\_capabilities) | n/a | `map(any)` | <pre>{<br/>  "all": {<br/>    "network_dns_enable": false,<br/>    "network_nat_enable": false,<br/>    "network_peer_enable": false,<br/>    "network_peer_type": "e2-micro",<br/>    "network_peer_zone": "b"<br/>  }<br/>}</pre> | no |
